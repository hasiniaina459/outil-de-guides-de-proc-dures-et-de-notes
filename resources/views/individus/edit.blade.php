...
@section('content')
    ...
    <form action="{{ route('individus.update', $individus->id_individu) }}" method="POST">
        ...
        <div>
            ...
            <div class="chip-grp">
                <input type="checkbox" name="notif_preference[]" class="chip-inp" id="info" value="information" {{ (is_array(old('notif_preference')) && in_array('information', old('notif_preference'))) ? 'checked' : '' }}>
                <label for="info" class="chip-lab"> information</label>
                <input type="checkbox" name="notif_preference[]" class="chip-inp" id="new" value="nouvelle" {{ (is_array(old('notif_preference')) && in_array('nouvelle', old('notif_preference'))) ? 'checked' : '' }}>
                <label for="new" class="chip-lab"> nouvelle</label>
                <input type="checkbox" name="notif_preference[]" class="chip-inp" id="fns" value="termine" {{ (is_array(old('notif_preference')) && in_array('termine', old('notif_preference'))) ? 'checked' : '' }}>
