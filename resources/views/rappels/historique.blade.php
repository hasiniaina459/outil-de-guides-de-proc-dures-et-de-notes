@extends('layouts.app')
@section('title', 'historique rappels')
@section('content')
<div class="retour">
    ...
    <h1>historique de rappels</h1>
</div>
<div class="champ">
    <a href="{{ route('rappels.historique.download') }}" class="btn-download">
...
<table>
    <thead>
        <tr>
            ...
            <th>date</th>
            <th>number max</th>
            <th class="non-inprimer">moyen</th>
        </tr>
    </thead>
    <tbody>
